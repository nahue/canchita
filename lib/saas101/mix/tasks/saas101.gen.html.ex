defmodule Mix.Tasks.Saas101.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix saas101.gen.html Accounts User users name:string age:integer
  ...
  with their respective names and types. See `mix saas101.gen.schema`
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix saas101.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix saas101.gen.html Sales User users --web Sales
  ...
  use binary ids for primary keys, see `mix saas101.gen.schema` for more
  information.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix saas101.gen.html must be invoked from within your *_web application root directory"
    end
  ...
  def files_to_be_generated(%Context{schema: schema, context_app: context_app}) do
    ...
    [
      ...
      {:eex, "index.html.heex",     Path.join([web_prefix, "templates", web_path, schema.singular, "index.html.eex"])},
      {:eex, "new.html.heex",       Path.join([web_prefix, "templates", web_path, schema.singular, "new.html.eex"])},
      {:eex, "show.html.heex",      Path.join([web_prefix, "templates", web_path, schema.singular, "show.html.eex"])},
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/saas101.gen.html", binding, files)
