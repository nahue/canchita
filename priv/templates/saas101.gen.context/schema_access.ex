  ...
  """
  def list_<%= schema.plural %>(prefix) do
    Repo.all(<%= inspect schema.alias %>, prefix: prefix)
  end
  ...
  """
  def get_<%= schema.singular %>!(id, prefix), do: Repo.get!(<%= inspect schema.alias %>, id, prefix: prefix)
  ...
  """
  def create_<%= schema.singular %>(attrs \\ %{}, prefix) do
    %<%= inspect schema.alias %>{}
  ...
  """
  def update_<%= schema.singular %>(%<%= inspect schema.alias %>{} = <%= schema.singular %>, attrs, prefix) do
    <%= schema.singular %>
    |> <%= inspect schema.alias %>.changeset(attrs)
  ...
  """
  def delete_<%= schema.singular %>(%<%= inspect schema.alias %>{} = <%= schema.singular %>, prefix) do
    Repo.delete(<%= schema.singular %>, prefix: prefix)
  end
